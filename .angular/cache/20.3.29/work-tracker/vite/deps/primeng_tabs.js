import { Ripple, RippleModule } from "./chunk-GOLIUMVP.js";
import { ChevronLeftIcon, ChevronRightIcon } from "./chunk-7MNC5NXP.js";
import "./chunk-2YOS6N5Y.js";
import { BaseComponent, PARENT_INSTANCE } from "./chunk-5DEUA4QB.js";
import { Bind, BindModule } from "./chunk-MQSTENXX.js";
import { BaseStyle } from "./chunk-EV24JKCH.js";
import { PrimeTemplate, SharedModule } from "./chunk-YILZXKZR.js";
import { K, Q, Rt, V, bt, k2 as k, s3 as s, v, z } from "./chunk-TIK557PQ.js";
import {
  CommonModule,
  NgTemplateOutlet,
  isPlatformBrowser,
...
function TabList_Conditional_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(
      0,
      TabList_Conditional_0_Conditional_2_ng_container_0_Template,
      1,
      0,
      "ng-container",
      11,
  ...
  if (rf & 2) {
    ...
    ɵɵproperty(
      "ngTemplateOutlet",
      ctx_r2.prevIconTemplate || ctx_r2._prevIconTemplate,
    );
  }
}
...
function TabList_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      "click",
      function TabList_Conditional_0_Template_button_click_0_listener() {
        ɵɵrestoreView(_r2);
    ...
    ɵɵconditionalCreate(
      2,
      TabList_Conditional_0_Conditional_2_Template,
      1,
      1,
      "ng-container",
    )(3, TabList_Conditional_0_Conditional_3_Template, 1, 0, ":svg:svg", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ...
    ɵɵattribute("aria-label", ctx_r2.prevButtonAriaLabel)(
      "tabindex",
      ctx_r2.tabindex(),
...
function TabList_Conditional_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(
      0,
      TabList_Conditional_8_Conditional_2_ng_container_0_Template,
      1,
      0,
      "ng-container",
      11,
  ...
  if (rf & 2) {
    ...
    ɵɵproperty(
      "ngTemplateOutlet",
      ctx_r2.nextIconTemplate || ctx_r2._nextIconTemplate,
    );
  }
}
...
function TabList_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      "click",
      function TabList_Conditional_8_Template_button_click_0_listener() {
        ɵɵrestoreView(_r4);
        const ctx_r2 = ɵɵnextContext();
    ...
    ɵɵconditionalCreate(
      2,
      TabList_Conditional_8_Conditional_2_Template,
      1,
      1,
      "ng-container",
    )(3, TabList_Conditional_8_Conditional_3_Template, 1, 0, ":svg:svg", 12);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ...
    ɵɵattribute("aria-label", ctx_r2.nextButtonAriaLabel)(
      "tabindex",
      ctx_r2.tabindex(),
    )("data-pc-group-section", "navigator");
    ɵɵadvance(2);
...
function TabPanel_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(
      0,
      TabPanel_Conditional_2_ng_container_0_Template,
      1,
      0,
      "ng-container",
      1,
  ...
  if (rf & 2) {
    ...
    ɵɵproperty(
      "ngTemplateOutlet",
      ctx_r0.content() ? ctx_r0.content() : defaultContent_r2,
    );
  }
}
var classes$4 = {
...
var TabsStyle = class _TabsStyle extends BaseStyle {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabsStyle_Factory(__ngFactoryType__) {
      return (
        ɵTabsStyle_BaseFactory ||
        (ɵTabsStyle_BaseFactory = ɵɵgetInheritedFactory(_TabsStyle))
      )(__ngFactoryType__ || _TabsStyle);
    };
  })();
...
var TabStyle = class _TabStyle extends BaseStyle {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabStyle_Factory(__ngFactoryType__) {
      return (
        ɵTabStyle_BaseFactory ||
        (ɵTabStyle_BaseFactory = ɵɵgetInheritedFactory(_TabStyle))
      )(__ngFactoryType__ || _TabStyle);
    };
  })();
  static ɵprov = ɵɵdefineInjectable({
    token: _TabStyle,
...
var TabListStyle = class _TabListStyle extends BaseStyle {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabListStyle_Factory(__ngFactoryType__) {
      return (
        ɵTabListStyle_BaseFactory ||
        (ɵTabListStyle_BaseFactory = ɵɵgetInheritedFactory(_TabListStyle))
      )(__ngFactoryType__ || _TabListStyle);
    };
  })();
  static ɵprov = ɵɵdefineInjectable({
    token: _TabListStyle,
...
var TabList = class _TabList extends BaseComponent {
  ...
  resizeObserver;
  showNavigators = computed(
    () => this.pcTabs.showNavigators(),
    ...(ngDevMode
      ? [
          {
  ...
  updateButtonState() {
    ...
    this.isNextButtonEnabled.set(
      _list.offsetWidth >= offsetWidth &&
        Math.abs(scrollLeft - scrollWidth + width) > 1,
    );
  }
  updateInkBar() {
    const _content = this.content?.nativeElement;
  ...
  getVisibleButtonWidths() {
    ...
    return [_prevBtn, _nextBtn].reduce(
      (acc, el) => (el ? acc + Rt(el) : acc),
      0,
    );
  }
  bindResizeObserver() {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function TabList_ContentQueries(rf, ctx, dirIndex) {
      ...
      if (rf & 2) {
        ...
        ɵɵqueryRefresh((_t = ɵɵloadQuery())) &&
          (ctx.prevIconTemplate = _t.first);
        ɵɵqueryRefresh((_t = ɵɵloadQuery())) &&
          (ctx.nextIconTemplate = _t.first);
    ...
    consts: [
      ...
      ["prevButton", ""],
      ["nextButton", ""],
      ["type", "button", "pRipple", "", 3, "pBind", "class"],
      [3, "scroll", "pBind"],
      ["role", "tablist", 3, "pBind"],
      ["role", "presentation", 3, "pBind"],
      ["type", "button", "pRipple", "", 3, "click", "pBind"],
      ["data-p-icon", "chevron-left"],
      [4, "ngTemplateOutlet"],
    ...
    template: function TabList_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(
          0,
          TabList_Conditional_0_Template,
          4,
          7,
          "button",
          5,
        ...
        ɵɵlistener(
          "scroll",
          function TabList_Template_div_scroll_1_listener($event) {
            ɵɵrestoreView(_r1);
      ...
      if (rf & 2) {
        ɵɵconditional(
          ctx.showNavigators() && ctx.isPrevButtonEnabled() ? 0 : -1,
        );
        ɵɵadvance();
        ...
        ɵɵadvance(2);
        ɵɵconditional(
          ctx.showNavigators() && ctx.isNextButtonEnabled() ? 8 : -1,
        );
      }
    },
    dependencies: [
...
var Tab = class _Tab extends BaseComponent {
  ...
  id = computed(
    () => `${this.pcTabs.id()}_tab_${this.value()}`,
    ...(ngDevMode
      ? [
          {
            debugName: "id",
  ...
  ariaControls = computed(
    () => `${this.pcTabs.id()}_tabpanel_${this.value()}`,
    ...(ngDevMode
      ? [
          {
  ...
  active = computed(
    () => k(this.pcTabs.value(), this.value()),
    ...(ngDevMode
      ? [
          {
            debugName: "active",
  ...
  tabindex = computed(
    () => (this.disabled() ? -1 : this.active() ? this.pcTabs.tabindex() : -1),
    ...(ngDevMode
      ? [
          {
            debugName: "tabindex",
  ...
  findNextTab(tabElement, selfCheck = false) {
    ...
    return element
      ? Q(element, "data-p-disabled") ||
        Q(element, "data-pc-section") === "activebar"
  ...
  findFirstTab() {
    return this.findNextTab(
      this.pcTabList?.tabs?.nativeElement?.firstElementChild,
      true,
    );
  }
  findLastTab() {
    return this.findPrevTab(
      this.pcTabList?.tabs?.nativeElement?.lastElementChild,
      true,
    );
  }
  changeActiveValue() {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function Tab_Factory(__ngFactoryType__) {
      return (
        ɵTab_BaseFactory || (ɵTab_BaseFactory = ɵɵgetInheritedFactory(_Tab))
      )(__ngFactoryType__ || _Tab);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _Tab,
    ...
    hostBindings: function Tab_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute("id", ctx.id())("aria-controls", ctx.ariaControls())(
          "role",
          "tab",
        )("aria-selected", ctx.active())("aria-disabled", ctx.disabled())(
          "data-p-disabled",
          ctx.disabled(),
        )("data-p-active", ctx.active())("tabindex", ctx.tabindex());
        ɵɵclassMap(ctx.cx("root"));
      }
    },
    inputs: {
    ...
    features: [
      ...
      ɵɵHostDirectivesFeature([Ripple, Bind]),
      ɵɵInheritDefinitionFeature,
    ],
    ngContentSelectors: _c7,
    decls: 1,
...
var TabPanelStyle = class _TabPanelStyle extends BaseStyle {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabPanelStyle_Factory(__ngFactoryType__) {
      return (
        ɵTabPanelStyle_BaseFactory ||
        (ɵTabPanelStyle_BaseFactory = ɵɵgetInheritedFactory(_TabPanelStyle))
      )(__ngFactoryType__ || _TabPanelStyle);
    };
  })();
  static ɵprov = ɵɵdefineInjectable({
...
var TabPanel = class _TabPanel extends BaseComponent {
  ...
  isLazyEnabled = computed(
    () => this.pcTabs.lazy() || this.lazy(),
    ...(ngDevMode
      ? [
          {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabPanel_Factory(__ngFactoryType__) {
      return (
        ɵTabPanel_BaseFactory ||
        (ɵTabPanel_BaseFactory = ɵɵgetInheritedFactory(_TabPanel))
      )(__ngFactoryType__ || _TabPanel);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _TabPanel,
    ...
    hostBindings: function TabPanel_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵattribute("id", ctx.id())("role", "tabpanel")(
          "aria-labelledby",
          ctx.ariaLabelledby(),
        )("data-p-active", ctx.active());
        ɵɵclassMap(ctx.cx("root"));
      }
    },
    inputs: {
    ...
    template: function TabPanel_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(
          0,
          TabPanel_ng_template_0_Template,
          1,
          0,
          "ng-template",
          null,
        ...
        ɵɵconditionalCreate(
          2,
          TabPanel_Conditional_2_Template,
          1,
          1,
          "ng-container",
        );
...
var TabPanelsStyle = class _TabPanelsStyle extends BaseStyle {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabPanelsStyle_Factory(__ngFactoryType__) {
      return (
        ɵTabPanelsStyle_BaseFactory ||
        (ɵTabPanelsStyle_BaseFactory = ɵɵgetInheritedFactory(_TabPanelsStyle))
      )(__ngFactoryType__ || _TabPanelsStyle);
    };
  })();
  static ɵprov = ɵɵdefineInjectable({
...
var TabPanels = class _TabPanels extends BaseComponent {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function TabPanels_Factory(__ngFactoryType__) {
      return (
        ɵTabPanels_BaseFactory ||
        (ɵTabPanels_BaseFactory = ɵɵgetInheritedFactory(_TabPanels))
      )(__ngFactoryType__ || _TabPanels);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _TabPanels,
...
var Tabs = class _Tabs extends BaseComponent {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function Tabs_Factory(__ngFactoryType__) {
      return (
        ɵTabs_BaseFactory || (ɵTabs_BaseFactory = ɵɵgetInheritedFactory(_Tabs))
      )(__ngFactoryType__ || _Tabs);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _Tabs,
